export { areaChartProps } from "@/shared/data/chart.example.data/areaChart.example.data";
export { barChartProps } from "@/shared/data/chart.example.data/barChart.example.data";
